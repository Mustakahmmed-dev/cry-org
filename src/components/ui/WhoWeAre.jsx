            ...
            <div>
              ...
              <div className="mt-8 grid grid-cols-1 gap-4">
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    <h3 className="font-semibold text-gray-900 mb-1">Justice & Equality</h3>
                    <p className="text-gray-600 text-sm">
                      Advocating for the rights and dignity of the Rohingya and other displaced communities.
                    </p>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    <h3 className="font-semibold text-gray-900 mb-1">Community Empowerment</h3>
                    <p className="text-gray-600 text-sm">
                      Building capacity through education, leadership, and youth-driven initiatives.
                    </p>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600 text-sm">
                      Promoting long-term solutions that strengthen livelihoods and protect the environment.
                    </p>
                  </div>
                </div>
              </div>
